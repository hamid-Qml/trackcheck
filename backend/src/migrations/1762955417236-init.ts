...
export class Init1762955417236 implements MigrationInterface {
    name = 'Init1762955417236'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "full_name" text, "password_hash" text NOT NULL, "password_reset_token_hash" text, "password_reset_token_expires_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "users_email_unique" ON "users" ("email") `);
        await queryRunner.query(`CREATE TABLE "audio_uploads" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "file_path" character varying NOT NULL, "original_file_name" character varying NOT NULL, "size_mb" double precision, "status" character varying NOT NULL DEFAULT 'uploaded', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "PK_af09cbbccb19035bf334b0a397e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ai_feedback" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "mix_quality_score" integer, "arrangement_score" integer, "creativity_score" integer, "suggestions_score" integer, "mix_quality_text" text, "arrangement_text" text, "creativity_text" text, "suggestions_text" text, "recommendations" jsonb, "reference_comparison_json" jsonb, "reference_track_summary" text, "model" text NOT NULL DEFAULT 'gpt-4o', "llm_usage" jsonb, "prompt_version" character varying(50), "raw_response" text, "status" character varying(20) NOT NULL DEFAULT 'completed', "error_message" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "upload_id" uuid, "reference_upload_id" uuid, CONSTRAINT "UQ_dcd717e205a3f71e649dab79a92" UNIQUE ("upload_id"), CONSTRAINT "REL_dcd717e205a3f71e649dab79a9" UNIQUE ("upload_id"), CONSTRAINT "PK_aa34b6654c98bf014129c13c1b0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "feedback_requests" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" character varying NOT NULL DEFAULT 'pending', "error_message" text, "feedback_focus" text, "genre" text, "user_note" text, "progress" jsonb DEFAULT '{}'::jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "upload_id" uuid, "reference_upload_id" uuid, CONSTRAINT "PK_4fceb8b13258b93add53a14d967" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "audio_features" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tempo" double precision, "key" character varying, "duration" double precision, "peak_rms" jsonb, "spectral_centroid" double precision, "spectral_rolloff" double precision, "bandwidth" double precision, "flatness" double precision, "energy_profile" jsonb, "transients_info" jsonb, "silence_segments" jsonb, "vocal_timestamps" jsonb, "vocal_intensity" double precision, "drop_timestamps" jsonb, "structure" jsonb, "structure_segments" jsonb, "fx_and_transitions" jsonb, "summary_snapshot" jsonb, "is_reference" boolean NOT NULL DEFAULT false, "extracted_at" TIMESTAMP NOT NULL DEFAULT now(), "uploadId" uuid, CONSTRAINT "REL_1179263e7dc2c6aa3b45bfb92c" UNIQUE ("uploadId"), CONSTRAINT "PK_5cea7a1dd2255ca0c8c43c8056c" PRIMARY KEY ("id"))`);
